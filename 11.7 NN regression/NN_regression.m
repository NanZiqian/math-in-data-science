...
for ii = 1:1e3
    ...
    for i = 1:N
        ...
        delta_2 = ((x2-y(i))/N).*dsigma(t2);
        dL_db2 = dL_db2 + delta_2;% delta^2
        dL_dw2 = dL_dw2 + delta_2*x1';
        delta_1 = (w2'*delta_2).*dsigma(t1);
        dL_db1 = dL_db1 + delta_1;
        dL_dw1 = dL_dw1 + delta_1*(data_z(i)');
    end
    w1 = w1 - yita*dL_dw1;
    w2 = w2 - yita*dL_dw2;
    b1 = b1 - yita*dL_db1;
